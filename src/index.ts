...
http.createServer(allnetApp).listen(PORT_ALLNET, '192.168.50.99', 511, () => {
...
https.createServer({key, cert}, muchaApp).listen(PORT_MUCHA, '192.168.50.99', 511, () => {
    console.log(`Mucha server listening on port ${PORT_MUCHA}!`);
})

// Create the game server
https.createServer({key, cert}, app).listen(PORT_BNGI, '192.168.50.99', 511, () => {
